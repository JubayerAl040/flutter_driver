  ...
  getPoly() async {
    ...
    for (var i = 1; i < addressList.length; i++) {
      ...
      if (api.statusCode == 200) {
        List poly = jsonDecode(api.body)['routes'][0]['legs'][0]['steps'];
        polyline.clear();
        for (var e in poly) {
                                                                                      ...
                                                                                      children: [
                                                                                        Row(
                                                                                          children: [
                                                                                            ...
                                                                                            MyText(
                                                                                              text: choosenRide[0]['km'].toString(),
                                                                                              // maxLines: 1,
                                                                                            ...
                                                                                            Column(
                                                                                              children: [
                                                                                                (driverReq['is_bid_ride'] == 1)
                                                                                                    ? MyText(
                                                                                                        text: '${userDetails['currency_symbol']} ${driverReq['accepted_ride_fare'].toString()}',
                                                                                                        size: media.width * eighteen,
                                                                                                        color: textColor,
                                                                                                      )
                                                                                                    : MyText(
